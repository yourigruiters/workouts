              ...
              <ScrollView showsVerticalScrollIndicator={false} className="mt-4" keyboardShouldPersistTaps="handled">
                  ...
                  <View className="flex-row bg-slate-100 p-1 rounded-2xl border border-slate-200">
                    <TouchableOpacity
                      ...
                      className={`flex-1 py-2.5 rounded-xl items-center ${
                        type === 'active' ? 'bg-white' : 'bg-transparent'
                      }`}
                    >
                      <Text
                    ...
                    <TouchableOpacity
                      ...
                      className={`flex-1 py-2.5 rounded-xl flex-row items-center justify-center ${
                        type === 'warmup' ? 'bg-amber-100' : 'bg-transparent'
                      }`}
                    >
                ...
                <View className="flex-row space-x-3 mb-4">
                  ...
                  <View className="flex-1 mr-2">
                    ...
                    <TextInput
                      ...
                      className="bg-slate-50 border border-slate-200 text-slate-900 rounded-xl font-bold"
                    />
                  </View>
                ...
                <View className="mb-5">
                  ...
                  <TextInput
                    ...
                    className="bg-slate-50 border border-slate-200 text-slate-900 rounded-xl font-bold mb-2"
                  />
